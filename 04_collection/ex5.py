...
for i, key in enumerate(d):
    print(i, key)  # 여기서 리턴되는 enumerate는 인덱스가 아님, 다만 실행은 됨
...
print(sorted(d.items(), key=key, reverse=True))
...
d2 = {"sci": 95, "prog": 100}
# print(d + d2)
print(d | d2)  # 이러면 합쳐지고 value는 뒤의 d2 로 덮어씌워짐(물론 겹치는 key가 있으면)


# 딕셔너리 반복하기 => 이것도 당연히 지원되지 않음
# print(d * 2)
