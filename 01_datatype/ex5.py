...
# print(s.index("Java"))  # 인덱스 반환 ( 없으면 에러 띄워버림)
...
print(
    "123".isdigit()
)  # 숫자이면 True, -를 숫자로 인식하지 않기 때문에 -123 이런건 숫자로 인식 못함, 그리고 . 도 문자로 인식해서 안됨. 순수한 양수만 인식한다고 보면 됨
print("123".isnumeric())  # 숫자이면 True, isdigit 보다 더 큰 범위. 한자 1도 숫자로 인식
